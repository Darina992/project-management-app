const i18Obj = {
  en: {
    ...
    nameA: 'Asel',
    nameD: 'Darya',
    teamContentV: ['Welcome Page', 'Localization', 'Board page'],
    teamContentA: ['Main Page', 'Form for creating columns', 'Modal with task description'],
    teamContentD: [
      'Login forms',
      'User authorization',
    ...
    profileDeleteTextConfirm: 'Are you sure you want to delete your profile?',
    profileDeleteTextUnsuccess: 'User is not found!',
    addTask: 'Add task',
    ...
    createdTask: 'Created: ',
    titleTaskModal: 'Title: ',
    inputTitleTask: 'Title task',
    descriptionTask: 'Description: ',
    inputDescriptionTask: 'Description task',
    change: 'Change',
    save: 'Save',
    delete: 'Delete',
  ...
  ru: {
    ...
    nameA: 'Асель',
    nameD: 'Дарья',
    teamContentV: ['Страница приветствия', 'Локализация приложения', 'Страница доски'],
    teamContentA: ['Главная страница', 'Форма создания колонок', 'Окно с описанием задачи'],
    teamContentD: [
    ...
    profileDeleteTextConfirm: 'Вы точно хотите удалить профиль?',
    profileDeleteTextUnsuccess: 'Юзер не найден!',
    ...
    createdTask: 'Создал: ',
    titleTaskModal: 'Заголовок: ',
    inputTitleTask: 'Название задачи',
    descriptionTask: 'Описание: ',
    inputDescriptionTask: 'Описание задачи',
    change: 'Изменить',
    save: 'Сохранить',
    delete: 'Удалить',
